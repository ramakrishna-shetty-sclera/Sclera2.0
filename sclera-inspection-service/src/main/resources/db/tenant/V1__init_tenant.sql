-- Tenant-schema tables for sclera-inspection-service (schema-per-tenant).
-- Identical to the legacy shared-schema DDL (db/migration/V1) so
-- INSERT…SELECT * data lifts work; org_id retained as a defense-in-depth
-- cross-check only — isolation comes from the schema itself.
