...
public class QuestionTemplateController {
    ...
    @GetMapping("/{id}")
    @PreAuthorize("@fga.check('question_template', #id, 'can_view')")
    public QuestionTemplateResponse get(@PathVariable UUID id) {
        return service.get(id);
    }

    @PutMapping("/{id}")
    @PreAuthorize("@fga.check('question_template', #id, 'can_edit')")
    ...
    @PreAuthorize("@fga.check('question_template', #id, 'can_publish')")
    public QuestionTemplateResponse publish(@PathVariable UUID id) {
        return service.publish(id);
    }

    @DeleteMapping("/{id}")
    @PreAuthorize("@fga.check('question_template', #id, 'can_delete')")
